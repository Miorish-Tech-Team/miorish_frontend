...
import { Mail, Globe, X, Phone } from "lucide-react";
...
export default function CustomerSupportModal({ isOpen, onClose }: ContactModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            <p className="font-bold text-lg text-dark">Miorish</p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="mailto:support@miorish.com" className="text-dark font-medium">
                  support@miorish.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="https://www.miorish.com" target="_blank" rel="noopener noreferrer" className="text-blue-600  font-medium">
                  https://www.miorish.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-xs uppercase tracking-widest text-gray-500 font-bold">Helpline:</p>
                <p className="text-dark font-medium"> +91-8388942410</p>
              </div>
            </div>
          </div>
        </div>
