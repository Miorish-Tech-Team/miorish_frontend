        ...
        <div className="flex items-center justify-between lg:justify-center gap-2 md:gap-16 lg:gap-32">
          ...
          >
            <div className="relative w-full" ref={categoryDropdownRef}>
              ...
              <div
                className={`flex w-full bg-white rounded-lg overflow-hidden border-2 transition-colors duration-200 
      ${
        showCategoryDropdown
          ? "border-accent"
          : "border-transparent focus-within:border-accent shadow-sm"
      }`}
              >
                <button
                ...
                <input
                  ...
                  className="flex-1 px-4 py-3 text-dark text-sm focus:outline-none"
                />
