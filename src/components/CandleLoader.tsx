  ...
  return (
    <div className="min-h-screen bg-secondary flex items-center justify-center">
      <div className="flex flex-col items-center">
        {/* Logo Container */}
        <div className="relative w-48 h-48 md:w-100 md:h-100 animate-pulse-gentle">
          <Image
        ...
        {/* Optional: Minimalist Loading Bar */}
        <div className="mt-8 w-32 h-0.5 bg-gray-200 overflow-hidden relative">
          <div className="absolute inset-0 bg-accent animate-loading-slide"></div>
        </div>
